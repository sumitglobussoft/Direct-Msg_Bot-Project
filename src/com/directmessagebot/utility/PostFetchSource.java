...
public class PostFetchSource {
    ...
    public String fetchPageSourceWithProxyPost(String newurl, String urlParameter, String referer, String host) throws IOException {
...
//        HttpHost proxy = new HttpHost("195.154.161.103", portno);
    ...
    public String getSourceWithProxy(String newurl, String referer, String Host) throws IOException {
